...
export function Hero() {
  ...
  return (
    <div id="booking" className="bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-indigo-900/80 dark:to-blue-800/80 py-16 md:py-24 relative overflow-hidden transition-colors">
      {/* Decorative circles */}
      <div className="absolute -top-6 -left-6 w-24 h-24 bg-indigo-200 dark:bg-indigo-700 rounded-full opacity-50 dark:opacity-40"></div>
      <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-blue-200 dark:bg-blue-700 rounded-full opacity-50 dark:opacity-40"></div>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/40 to-blue-100/40 dark:from-indigo-900/50 dark:to-blue-800/50 z-0"></div>
